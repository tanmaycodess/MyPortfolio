...
const MobileExperienceCard = ({JobExperience , id}) => {

  return (
    <div id={id} className=''>
      {JobExperience.map(je => (
       <div className='flex-col gap-4 items-start hover:bg-blue-50/10 mb-4 rounded-xl'>
       <div className='w-28 shrink-0'>
         <p className='secondary-font-color mb-2 text-xs whitespace-nowrap'>
           {je.duration || je.year} 
         </p>
       </div>
       <div>
